...
python proyecto/ingest/get_data.py

# 3) Pipeline fin-a-fin (ingesta→clean→persistencia→reporte.md)
python proyecto/ingest/run.py

# 4) Copiar el reporte a la web Quartz
python proyecto/tools/copy_report_to_site.py
...
- El workflow `./.github/workflows/deploy.yml` compila `site/` y despliega.
